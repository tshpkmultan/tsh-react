...
const fetchAssignments = async () => {
    ...
    try {
        ...
        const res = await axios.get(
            `${API}/admin/assignments/list.php`,
            {
                params: {
...
const fetchPendingSubmissions = async () => {
    ...
    try {
        ...
        const res = await axios.get(
            `${API}/admin/assignments/pending.php`,
            {
                params: {
                    teacher_id: teacher.teacher_id,
                },
...
const viewSubmission = async (submissionId) => {
    ...
    try {
        ...
        const res = await axios.get(
            `${API}/admin/assignments/view_submission.php`,
            {
                params: {
                    id: submissionId
                }
        ...
        if (res.data.success) {
            ...
            setViewData(res.data.submission);
...
const updateAssignment = async () => {
    ...
    try {
        ...
        const res = await axios.post(
            ...
            `${API}/admin/assignments/update.php`,
...
const deleteAssignment = async (id) => {
    ...
    try{
        ...
        const res = await axios.post(
            ...
            `${API}/admin/assignments/delete.php`,
...
const saveGrade = async () => {
    ...
    try {
        ...
        const res = await axios.post(
            ...
            `${API}/admin/assignments/grade.php`,
...
const createAssignment = async () => {
    ...
    try {
        ...
        const res = await axios.post(
            `${API}/admin/assignments/create.php`,
            {
                ...formData,
                teacher_id: teacher.teacher_id,
...
return ( <div className="p-8 bg-[#F3F4F6] min-h-screen">
  ...
  {/* Header */}
  <div className="flex flex-col lg:flex-row gap-6 lg:gap-0 justify-between lg:items-center mb-10">
<div className="flex justify-center md:justify-end mb-8">
    <GoogleTranslate />
</div>
    <div>

        <h1 className="text-3xl md:text-5xl font-extrabold text-[#082B3A]">
...
<div className="flex-1 overflow-y-auto p-5 md:p-8">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
    ...
    <div className="bg-gray-50 rounded-2xl border p-5">
      ...
      <h3 className="text-xl md:text-2xl font-bold text-[#082B3A] mt-2 break-words">
        {viewData.teacher_name || "Not Assigned"}
      </h3>
    </div>
    ...
    <div className="bg-gray-50 rounded-2xl border p-5">
      ...
      <h3 className="text-lg md:text-xl font-bold text-[#082B3A] mt-2 break-words">
        {viewData.batch_name || "Individual Assignment"}
      </h3>
    </div>
  ...
  <div className="mt-8">
    ...
    <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6">
      ...
      <p className="leading-8 text-gray-700 whitespace-pre-line">
        ...
        {viewData.submission_text || "No submission notes."}
  ...
  {viewData.submission_file && (
    ...
    <div className="mt-8">
      ...
      {(viewData.submission_file.endsWith(".jpg") ||
        viewData.submission_file.endsWith(".jpeg") ||
        viewData.submission_file.endsWith(".png") ||
        viewData.submission_file.endsWith(".webp")) && (

        <img
          src={`https://800junkuae.online/tsh-api/uploads/assignments/${viewData.submission_file}`}
          alt="Submission"
          className="w-full max-h-[450px] object-contain rounded-2xl border shadow mb-5"
        />
      ...
      <a
        href={`https://800junkuae.online/tsh-api/uploads/assignments/${viewData.submission_file}`}
        target="_blank"
        rel="noreferrer"
        className="
        inline-flex
