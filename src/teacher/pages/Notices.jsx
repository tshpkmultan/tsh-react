...
useEffect(() => {
    ...
    const loginData = JSON.parse(localStorage.getItem("teacher"));

    console.log("Teacher Login:", loginData);

    if (!loginData) return;

    setTeacher(loginData);

    // role_id is the teacher id
    const teacherId = Number(loginData.role_id);
    ...
    fetchBatches(teacherId);
    fetchStudents(teacherId);
    fetchNotices(teacherId);
 ...
 const fetchBatches = async (teacher_id) => {

    try {

        const res = await axios.get(
            `${API}/teacher/notices/batches.php?teacher_id=${teacher_id}`
        );
 ...
 const fetchStudents = async (teacher_id) => {
    ...
    try {
        ...
        const res = await axios.get(
            `${API}/teacher/notices/students.php?teacher_id=${teacher_id}`
        );
  ...
  */
  ...
  const fetchNotices = async (teacher_id) => {

    try {

      const res = await axios.get(

        `${API}/teacher/notices/index.php?teacher_id=${teacher_id}`
...
const createNotice = async (e) => {
    ...
    try {
        ...
        const teacherId = Number(teacher.role_id);
        ...
        const res = await axios.post(
            ...
            `${API}/teacher/notices/create.php`,
...
const updateNotice = async () => {
    ...
    try {
        ...
        const res = await axios.post(
            ...
            `${API}/teacher/notices/update.php`,

            {

                ...editNotice,

                teacher_id: teacher.role_id
...
const deleteNotice = async (id) => {
    ...
    try {
        ...
        const res = await axios.post(
            ...
            `${API}/teacher/notices/delete.php`,
...
Broadcast announcements to your students.
