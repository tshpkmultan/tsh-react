   ...
   const fetchCourses = async () => {
    ...
    try {
        ...
        const res = await axios.get(
            `${BASE_URL}/digital_course/get-courses.php`
        );
...
const [upcomingSchedule,setUpcomingSchedule]=useState([]);
    ...
    */
    ...
    try {
        ...
        const res = await axios.get(
            `${API}/digital_trainer/dashboard.php`,
            {
                params: {
...
const quickActions = [
  {
    ...
    path: "/digital-teacher/attendance",
  },
  {
    ...
    path: "/digital-teacher/assignments",
  },
  {
    ...
    <div className="flex flex-col lg:flex-row justify-between items-center">
        ...
        <div>
            ...
            <h2 className="text-4xl lg:text-5xl font-bold">
               ...
               {greeting()}, {trainer?.name} 👋

            </h2>

            <p className="mt-4 text-gray-200 text-lg">

               Welcome back to your Digital Trainer Dashboard.

Manage your digital courses, batches,
students, assignments and schedules
from one place.
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between gap-6">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <span
                            className={`px-4 py-1 rounded-full text-sm font-bold ${getStatusColor(item.status)}`}
                        >
                            {item.status}
                        </span>
                ...
                <div className="flex flex-col justify-between gap-4">
                    ...
                    <button
                        onClick={() => joinMeeting(item.meeting_link)}
...
<div className="grid grid-cols-1 xl:grid-cols-3 gap-8 mt-8">
    ...
    <div className="xl:col-span-2 bg-white rounded-3xl shadow-md p-8">
      ...
      <button
    onClick={() =>
        navigate(`/digital-teacher/student-profile/${student.user_id}`)
    }
    ...
    <div className="flex flex-col lg:flex-row justify-between items-center">
        ...
        <div>
            ...
            <h2 className="text-3xl font-bold">
                ...
                Have a productive training day! 🚀
